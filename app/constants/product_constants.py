# FILE: app/constants/product_constants.py
from typing import Dict, List

APPLICATION_METHODS = [
    "Smoking", "Vaping", "Edible", "Capsule/Pill", "Sublingual (Tincture/Oil)",
    "Topical (Non-ingestible)", "Transdermal Patch", "Beverage", "Other"
]

TERPENES: List[str] = [
    "Myrcene", "Limonene", "Beta-Caryophyllene", "Alpha-Pinene", "Linalool",
    "Humulene", "Terpinolene", "Ocimene", "Bisabolol", "Nerolidol",
    "Eucalyptol", "Camphene", "Borneol", "Terpineol", "Valencene",
    "Geraniol", "Fenchol", "Sabinene", "Caryophyllene", "Pulegol"
]
...
TERPENE_CHARACTERISTICS: Dict[str, List[str]] = {
    "Myrcene": ["relaxing", "sedative", "calming"],
    "Limonene": ["uplifting", "energetic", "anti-anxiety"],
    "Caryophyllene": ["spicy", "soothing", "anti-inflammatory"],
    "Linalool": ["stress relief", "floral", "sleep aid"],
    "Pinene": ["alertness", "memory", "piney"],
    "Humulene": ["anxiety suppressant", "anti-anxiety"],
    "Terpinolene": ["creative", "uplifting", "herbal"],
    "Ocimene": ["energizing", "sweet", "herbal"],
    "Bisabolol": ["relaxing", "floral", "sleep aid"],
    "Nerolidol": ["relaxing", "floral", "sleep aid"],        
    "Eucalyptol": ["antibacterial", "antifungal"],
    "Camphene": ["calming", "floral"],
    "Borneol": ["relaxing", "floral", "sleep aid"],
    "Terpineol": ["calming", "sleep aid"],    
    "Valencene": ["positive", "alertness"],
    "Geraniol": ["relaxing", "floral", "sleep aid"],    
    "Fenchol": ["calming", "floral"],
    "Sabinene": ["antixidative", "antioxidant"],    
    "Pulegol": ["insect repellent", "pain relief", "reduce temperature"], 
    "Transnerol": ["antiparasitic"],
    "Phellandrene": ["calming", "floral"],
}
